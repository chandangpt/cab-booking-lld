...
import com.chandan.cabbooking.exceptions.CabAlreadyExistsException;
import com.chandan.cabbooking.exceptions.CabNotFoundException;
...
public class CabsManager {
    ...
    public void updateCabAvailability(@NonNull final String cabId, Boolean newAvailability) {
        if(!cabs.containsKey(cabId)) {
            throw new CabNotFoundException();
        }
